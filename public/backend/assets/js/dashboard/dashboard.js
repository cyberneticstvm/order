    ...
    $.getJSON('/ajax/chart/order/comparison/'+ 0, function (response) {
        ...
        var ordercomparisonchartoptions = {
            series: [
              ...
              {
                name: "Delivered",
                data: [response.del[0].dcount, response.del[1].dcount, response.del[2].dcount, response.del[3].dcount, response.del[4].dcount, response.del[5].dcount, response.del[6].dcount, response.del[7].dcount, response.del[8].dcount, response.del[9].dcount, response.del[10].dcount, response.del[11].dcount],
              },
            ],
            chart: {
              type: "bar",
