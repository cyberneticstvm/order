...
function addPurchaseRowFrame(category, type) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (res) {
            $(".tblPharmacyPurchaseBody").append(`<tr><td class="text-center"><a href="javascript:void(0)" class="dltRow"><i class="fa fa-trash text-danger"></i></a></td><td><select class="form-control select2 selPdct" name="product_id[]" required><option></option></select></td><td><input type="number" name='qty[]' class="w-100 border-0 text-end pQty" placeholder="0" min='1' step="1" required /></td><td><input type="number" name='purchase_price[]' class="w-100 border-0 text-end pPPrice" placeholder="0.00" min='1' step="any" required /></td><td><input type="number" name='item_tot[]' class="w-100 border-0 text-end itemTot" placeholder="0.00" min='1' step="any" required /></td><td><input type="number" name='discount[]' class="w-100 border-0 text-end" placeholder="0.00" min='1' step="any" required /></td><td><input type="number" name='tax_amount[]' class="w-100 border-0 text-end" placeholder="0.00" min='' step="any" /></td><td><input type="number" name='total[]' class="w-100 border-0 text-end pTotal" placeholder="0.00" min='1' step="any" required readonly /></td></tr>`);
            var xdata = $.map(res.products, function (obj) {
                obj.text = obj.name || obj.id;
                return obj;
            });
