                ...
                if(res.products && dis.hasClass('offerPdct')){   
                    if(res.get_number > 0){
                        for(var i = 0; i < res.get_number; i++)
                            ...
                            $(".powerbox tr:last").find('.selPdct').removeClass('offerPdct');
                    }                   
