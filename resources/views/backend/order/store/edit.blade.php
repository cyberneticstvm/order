                                        ...
                                        <table class="table table-bordered table-stripped mt-3">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-0"><input type="text" name="balance" class="text-end border-0 fw-bold w-100 balance readOnly" placeholder="0.00" value="{{ number_format($order->invoice_total - ($item->order->sum('amount') + $order->credit_used), 2) }}" /></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
