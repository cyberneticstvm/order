                                    ...
                                    <div class="col text-end">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-block">
                                                <li><a class="dropdown-item txt-dark" href="javascript:void(0)" onclick="addStoreOrderRow('solution', 'order', 0)"><i class="fa fa-eye txt-danger fw-bold"></i> Solution</a></li>
                                                <li><a class="dropdown-item txt-dark" href="javascript:void(0)" onclick="addStoreOrderRow('accessory', 'order', 0)"><i class="fa fa-square-o txt-success fw-bold"></i> Accessory</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <table class="table table-bordered table-stripped mt-3">
                                            ...
                                            <tbody class="powerbox">
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products->pluck('name', 'id'), (old('product_id')) ? old('product_id')[0] : '')->class('border-0 select2 selPdct')->attribute('data-batch', 'NA')->attribute('data-category', 'solution')->attribute('id', 'cat-solution1')->placeholder('Select')->required() }}
                                                    </td>
                                                    <td>
                                                        {{ html()->text('batch_number[]', (old('batch_number')) ? old('batch_number')[0] : '')->class('form-control')->placeholder('Batch Number') }}
                                                    </td>
                                                    <td>
                                                        {{ html()->date('expiry_date[]', old('expiry_date')[0] ?? date('Y-m-d'))->class('form-control')->placeholder(date('Y-m-d')) }}
                                                    </td>
