                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('stock.comparison.update') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-3">
                                    <label class="form-label">Branch</label>
                                    <div class="input-group">
                                        {{ html()->select('branch', $branches->pluck('name', 'id'), Session::get('branch'))->class('form-control select2') }}
                                    </div>
                                    @error('branch')
