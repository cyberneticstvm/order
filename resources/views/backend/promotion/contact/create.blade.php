...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Create Promotion Contact</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Create Promotion Contact</h4>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('promotion.contact.save') }}">
                                @csrf
                                <div class="col-md-3">
                                    <label class="form-label req">Customer Name</label>
                                    {{ html()->text($name = 'name', old('name'))->class('form-control')->placeholder('Customer Name') }}
                                    @error('name')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->text($name = 'contact_number', old('contact_number'))->class('form-control')->maxlength('10')->placeholder('Contact Number') }}
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select('type', array('include' => 'Include', 'exclude' => 'Exclude'), old('type'))->class('form-control select2')->placeholder('Select') }}
                                    @error('type')
