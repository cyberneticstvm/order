                        ...
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('promotion.schedule.update', $schedule->id) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select('entity', array('store' => 'Store'), $schedule->entity)->class('form-control select2')->placeholder('Select') }}
                                    @error('entity')
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select('branch_id', $branches, $schedule->branch_id)->class('form-control select2')->placeholder('Select') }}
                                    @error('branch_id')
