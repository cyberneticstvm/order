            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Lens Update</h5><span>Purchase Lens Update</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('lens.purchase.update', $purchase->id) }}">
                                @csrf
                                <div class="col-md-2">
