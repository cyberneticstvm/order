            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Pharmacy</h5><span>Purchase Pharmacy</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('pharmacy.purchase.save') }}">
                                @csrf
                                <div class="col-md-2">
                                        ...
                                        <table class="table table-bordered table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyPurchaseBody">
                                                <tr>
                                                    ...
                                                    <td><input type="text" name='batch_nmber[]' class="w-100 border-0 text-center" placeholder="Batch Number" required /></td>
                                                    <td><input type="date" name='expiry_date[]' class="w-100 border-0 text-center" value="{{ date('Y-m-d') }}" required /></td>
