...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Purchase Update - Pharmacy</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Pharmacy Update</h5><span>Purchase Pharmacy Update</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('pharmacy.purchase.update', $purchase->id) }}">
                                @csrf
                                <div class="col-md-2">
                                ...
                                <div class="row g-4 table-responsive">
                                    <div class="col text-end">
                                        <div class="btn-group">
                                            <button class="btn btn-primary" type="button" onclick="addPurchaseRowPharmacy('pharmacy', 'purchase')">Add New Row</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <table class="table table-bordered table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyPurchaseBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name='batch_nmber[]' class="w-100 border-0 text-center" placeholder="Batch Number" value="{{ $item->batch_number }}" required /></td>
                                                    <td><input type="date" name='expiry_date[]' class="w-100 border-0 text-center" value="{{ $item->expiry_date?->format('Y-m-d') }}" required /></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="4" class="text-end fw-bold border-0">Total</td>
