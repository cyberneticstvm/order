...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Purchase Update - Accessory</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Accessory Update</h5><span>Purchase Accessory Update</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('accessory.purchase.update', $purchase->id) }}">
                                @csrf
                                <div class="col-md-2">
