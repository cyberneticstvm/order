            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Accessory</h5><span>Purchase Accessory</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('accessory.purchase.save') }}">
                                @csrf
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select('branch_id', $branches, old('branch_id'))->class('form-control select2')->placeholder('Select')->required() }}
                                    @error('branch_id')
                                ...
                                <div class="row g-4 table-responsive">
                                    <div class="col text-end">
                                        <div class="btn-group">
                                            <button class="btn btn-primary" type="button" onclick="addPurchaseRowFrame('accessory', 'purchase')">Add New Row</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
