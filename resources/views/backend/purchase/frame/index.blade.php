            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h5>Purchase Register</h5><span>Frame Purchase Management</span>
                            </div>
                            <div class="col text-end">
                                <div class="btn-group">
                                    <a href="{{ route('frame.purchase.create') }}" class="btn btn-primary" type="button">Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="display" id="dataTable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">{{ number_format($item->detail->sum('total') + $item->other_charges + ($item->adjust_type == 'minus') ? -abs($item->adjust_amount) : $item->adjust_amount, 2) }}</td>
