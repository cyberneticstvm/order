            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Purchase Solution</h5><span>Purchase Solution</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('solution.purchase.save') }}">
                                @csrf
                                <div class="col-md-2">
                                ...
                                <div class="row g-4 table-responsive">
                                    <div class="col text-end">
                                        <div class="btn-group">
                                            <button class="btn btn-primary" type="button" onclick="addPurchaseRowFrame('solution', 'purchase')">Add New Row</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
