                        ...
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('collection.update', $collection->id) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'attribute', $value = array('type' => 'Type', 'shape' => 'Shape', 'collection' => 'Collection', 'colour' => 'Colour'), $collection->attribute)->class('form-control')->placeholder('Attribute') }}
                                    @error('attribute')
