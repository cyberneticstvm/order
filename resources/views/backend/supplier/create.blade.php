            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Create Supplier</h5><span>Create New Supplier</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('supplier.save') }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->text($name = 'name', $value = old('name'))->class('form-control')->placeholder('Supplier Name') }}
                                    @error('name')
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->text($name = 'contact_person', $value = old('contact_person'))->class('form-control')->placeholder('Contact Person') }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->number($name = 'expiry_notification', $value = old('expiry_notification'))->class('form-control')->placeholder('0 Days') }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->number($name = 'opening_balance', 0.00, '', '', '')->class('form-control')->placeholder('0.00') }}
                                </div>
