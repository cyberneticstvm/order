            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update Product</h5><span>Update Solution Product</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('product.solution.update', $product->id) }}">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'brand_id', $value = $brands->pluck('name', 'id'), $product->brand_id)->class('form-control select2')->placeholder('Select') }}
                                    @error('brand_id')
