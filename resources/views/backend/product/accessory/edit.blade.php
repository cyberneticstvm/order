            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update Product</h5><span>Update Accessory Product</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('product.accessory.update', $product->id) }}">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'color', $value = $ptypes->where('attribute', 'colour')->pluck('name', 'id'), $product->color)->class('form-control select2')->placeholder('Select') }}
                                </div>
                                <div class="col-md-2">
