                        ...
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('product.frame.update', $product->id) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    {{ html()->select($name = 'collection_id[]', $collection->where('category', 'frame')->where('attribute', 'collection')->pluck('name', 'id'), $product->collection->pluck('collection_id'))->class('form-control select2')->multiple() }}
                                    @error('collection_id')
