...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Create Spectacle Prescription</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('spectacle.save') }}">
                                @csrf
                                <input type="hidden" name="registration_id" value="{{ $registration?->id ?? 0}}" />
                                <input type="hidden" name="customer_id" value="{{ $registration->customer?->id ?? 0}}" />
                                <div class="col-md-3">
                                    <label class="form-label req">Customer Name</label>
                                    {{ html()->text($name = 'name', $value = $registration->customer->name)->class('form-control')->placeholder('Customer Name')->disabled() }}
                                    @error('name')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select('spectacle_id', $hospital_prescriptions, '')->class('form-control select2 changePresc')->attribute('data-source', 'hospital')->placeholder('Select') }}
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Optometrist (Hospital)</label>
                                    {{ html()->text($name = 'optometrist_hospital', old('optometrist_hospital'))->class('form-control hOpto')->placeholder('Optometrist (Hospital)') }}
                                </div>
                                ...
                                <div class="col-md-6 mt-5">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            {{ html()->textarea('notes', '')->class('form-control')->placeholder('Notes / Remarks') }}
                                        </div>
                                        <div class="col-md-12 mt-3">
                                            <label class="form-label">Advice</label>
                                            {{ html()->textarea('advice', '')->class('form-control')->placeholder('Advice') }}
                                        </div>
                                    </div>
                                </div>
