                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('report.product.damage.fetch') }}">
                                @csrf
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'status', array('0' => 'Pending', '1' => 'Approved'), ($inputs[2]) ?? old('head'))->class('form-control select2')->placeholder('Select') }}
                                </div>
                                <div class="col-md-3">
                            ...
                            <table class="display" id="dataTable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ ($item->approved_status) ? 'Approved' : 'Pending' }}</td>
                                    </tr>
                                    @empty
                                    @endforelse
                                </tbody>
