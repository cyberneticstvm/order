                            ...
                            <table class="display" id="dataTable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $item->ono() }}</td>
                                        <td class="text-center"><a class="txt-primary fw-bold" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="tooltip" data-bs-original-title="">{{ $item->details->where('eye', 'frame')->sum('qty') }}</a></td>
