                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <h5 class="txt-primary">{{ $camp->name }} - {{ $camp->camp_id }}</h5>
                        </div>
                                ...
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <table class="table table-bordered table-sm mt-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>RE</td>
                                                <td><input type="text" name="re_vb" class="border-0 text-center" maxlength="6" placeholder="VB" value="{{ old('re_vb') }}"></td>
                                                <td><input type="text" name="re_sph" class="border-0 text-center" maxlength="6" placeholder="SPH" value="{{ old('re_sph') }}"></td>
                                            ...
                                            <tr>
                                                <td>LE</td>
                                                <td><input type="text" name="le_vb" class="border-0 text-center" maxlength="6" placeholder="VB" value="{{ old('le_vb') }}"></td>
