                        ...
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('vehicle.payment.save', $vehicle->id) }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->number($name = 'amount', $value = $vehicle->fee, '1', '', '')->class('form-control') }}
                                    @error('amount')
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->text($name = 'upi_id', $vehicle->upi_id ?? null)->class('form-control')->maxLength(50)->placeholder('UPI Id') }}
                                    @error('upi_id')
