                            ...
                            <table class="display" id="dataTable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0)" class="payment" data-type="payment" data-vid="{{ $vehicle->id }}" data-vno="{{ $vehicle->reg_number }}" data-branch="" data-drawer="paymentDrawer"><i class="fa fa-qrcode fa-xl text-success"></i></a></td>
