            ...
            <div class="col-sm-12 file-content">
                <div class="card">
                    <div class="card-header">
                        <h5>Create Procedure</h5><span>Confirm Details</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper row g-4">
                            ...
                            <div class="col-12 text-center">
                                <a class="btn btn-success" type="submit" href="{{ route('patient.procedure.create', encrypt($consultation->id)) }}">Proceed</a>
