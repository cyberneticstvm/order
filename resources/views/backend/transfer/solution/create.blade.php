            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Solution</h5><span>Transfer Solution</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('solution.transfer.save') }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
