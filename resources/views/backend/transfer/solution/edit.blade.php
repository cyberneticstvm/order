...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Transfer Update - Solution</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Update Solution</h5><span>Transfer Update Solution</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('solution.transfer.update', $transfer->id) }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products->pluck('name', 'id'), $item->product_id)->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'solution')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
