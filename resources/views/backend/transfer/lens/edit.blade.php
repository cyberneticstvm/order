            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Update Lenses</h5><span>Transfer Update Lenses</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('lens.transfer.update', $transfer->id) }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
                                ...
                                <div class="row g-4 table-responsive">
                                    <div class="col text-end">
                                        <div class="btn-group">
                                            <button class="btn btn-primary" type="button" onclick="addTransferRow('lens', 'transfer')">Add New Row</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products, $item->product_id)->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'lens')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
