            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Lenses</h5><span>Transfer Lenses</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('lens.transfer.save') }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products, old('product_id'))->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'lens')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
