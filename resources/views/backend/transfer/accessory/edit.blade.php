...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Transfer Update - Accessory</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Update Accessory</h5><span>Transfer Update Accessory</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('accessory.transfer.update', $transfer->id) }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products->pluck('name', 'id'), $item->product_id)->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'accessory')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
