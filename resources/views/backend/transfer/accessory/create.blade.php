                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products, old('product_id'))->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'accessory')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
