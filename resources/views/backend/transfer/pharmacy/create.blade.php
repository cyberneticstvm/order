            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Transfer Pharmacy</h5><span>Transfer Pharmacy</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('pharmacy.transfer.save') }}" id="transferForm">
                                @csrf
                                <div class="col-md-2">
                                        ...
                                        <table class="table table-bordered table-sm table-stripped mt-3">
                                            ...
                                            <tbody class="tblPharmacyTransferBody">
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ html()->select('product_id[]', $products, old('product_id'))->class('border-0 select2 selPdctForTransfer')->attribute('data-category', 'pharmacy')->attribute('id', '')->placeholder('Select')->required() }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><input type="number" name='qty[]' class="w-100 border-0 text-end" placeholder="0" min='1' step="1" required /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
