            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update Category</h5><span>Update Offer Category</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('offer.category.update', $category->id) }}">
                                ...
                                <div class="col-md-5">
                                    ...
                                    {{ html()->select($name = 'collection_id', $collection, old('collection_id', $category->collection_id))->class('form-control select2')->placeholder('Select') }}
                                    @error('collection_id')
