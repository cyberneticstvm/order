                            ...
                            <table class="table table-sm" style="width:100%" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td><a href="javascript:void(0)" class="dayBook {{ $item->order?->isEdited() ?? 'text-success' }}" data-from-date="" data-to-date="" data-type="order" data-mode="{{ $item->order?->id }}" data-branch="" data-drawer="orderDrawer">{{ $item->order?->ono() }}</a></td>
