                            ...
                            <table class="table table-sm" style="width:100%" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center"><a href="javascript:void(0)" class="labNote" data-drawer="labNoteDrawer" data-oid="{{ $item->order_id }}"><i class="fa fa-edit text-primary fa-lg"></i></a></td>
