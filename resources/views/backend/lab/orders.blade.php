                            ...
                            <table class="table table-sm" style="width:100%" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="{{ ($item->lab_id == '0') ? 'text-muted' : ''  }}">{{ $item->created_at->format('d.M.Y') }}</td>
                                        <td><a href="javascript:void(0)" class="dayBook text-warning {{ $item->order?->isEdited() }}" data-from-date="" data-to-date="" data-type="order" data-mode="{{ $item->order?->id }}" data-branch="" data-drawer="orderDrawer">{{ $item->order?->ono() }}</a></td>
