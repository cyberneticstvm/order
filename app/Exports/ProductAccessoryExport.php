...
class ProductAccessoryExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    {
        return ['SL No', 'Product Name', 'Product Code', 'Product Material', 'Product Coating', 'Product Type', 'Manufacturer', 'MRP', 'Selling Price', 'Tax %', 'Reorder Level', 'Description'];
    }
