...
class ProductFrameExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    {
        return ['SL No', 'Product Name', 'Product Code', 'Product Material', 'Product Shape', 'Product Type', 'Manufacturer', 'MRP', 'Selling Price', 'Tax %', 'Reorder Level', 'Description'];
    }
