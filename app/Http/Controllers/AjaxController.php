        ...
        switch ($request->type):
            ...
            case 'order':
                ...
                foreach ($order->details as $key => $item) :
                    $op .= "<tr><td>" . strtoupper($item->eye) . "</td><td>" . $item->product->name . "</td><td>" . $item->qty . "</td><td>" . $item->sph . "</td><td>" . $item->cyl . "</td><td>" . $item->axis . "</td><td>" . $item->add . "</td><td>" . $item->ipd . "</td><td>" . $item->product->price . "</td></tr>";
                endforeach;
                $op .= "</tbody></table>";
