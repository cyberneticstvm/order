...
class PurchaseAccessoryController extends Controller
{
    ...
    {
        $this->middleware('permission:purchase-accessory-list|purchase-accessory-create|purchase-accessory-edit|purchase-accessory-delete', ['only' => ['index', 'store']]);
        $this->middleware('permission:purchase-accessory-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:purchase-accessory-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:purchase-accessory-delete', ['only' => ['destroy']]);

        $this->purchases = Purchase::where('category', 'accessory')->whereDate('delivery_date', Carbon::today())->withTrashed()->latest()->get();
    ...
    public function index()
    {
        ...
        return view('backend.purchase.accessory.index', compact('purchases'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.purchase.accessory.create', compact('suppliers', 'products', 'branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function () use ($request) {
                $purchase = Purchase::create([
                    'category' => 'accessory',
                    'purchase_number' => purchaseId('accessory')->pid,
        ...
        return redirect()->route('accessory.purchase')->with("success", "Purchase created successfully!");
    }
    ...
    public function edit(string $id)
    {
        ...
        $branches = Branch::where('ho_master', 1)->pluck('name', 'id');
        return view('backend.purchase.accessory.edit', compact('suppliers', 'products', 'purchase', 'branches'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('accessory.purchase')->with("success", "Purchase updated successfully!");
    }
