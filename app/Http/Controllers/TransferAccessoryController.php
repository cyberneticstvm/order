...
class TransferAccessoryController extends Controller
{
    /**
    ...
    {
        $this->middleware('permission:accessory-transfer-list|accessory-transfer-create|accessory-transfer-edit|accessory-transfer-delete', ['only' => ['index', 'store']]);
        $this->middleware('permission:accessory-transfer-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:accessory-transfer-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:accessory-transfer-delete', ['only' => ['destroy']]);
    ...
    public function index()
    {
        ...
        return view('backend.transfer.accessory.index', compact('transfers'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.transfer.accessory.create', compact('products', 'branches', 'tobranches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function () use ($request) {
                $transfer = Transfer::create([
                    'transfer_number' => transferId('accessory')->tid,
                    'category' => 'accessory',
        ...
        return redirect()->route('accessory.transfer')->with("success", "Product transferred successfully!");
    }
    ...
    public function edit(string $id)
    {
        ...
        $tobranches = $this->tobranches;
        return view('backend.transfer.accessory.edit', compact('products', 'branches', 'transfer', 'tobranches'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('accessory.transfer')->with("success", "Product transfer updated successfully!");
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('accessory.transfer')->with("success", "Product transfer deleted successfully!");
    }
}
