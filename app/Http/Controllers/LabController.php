...
class LabController extends Controller
{
    ...
    public function assignOrders()
    {
        ...
        $orders = OrderDetail::leftJoin("lab_orders as lo", "lo.order_detail_id", "order_details.id")->leftJoin('orders as o', 'o.id', 'order_details.order_id')->selectRaw("order_details.*, lo.lab_id")->whereIn('order_details.eye', ['re', 'le'])->orWhere('order_details.fitting', 1)->when(!in_array(Auth::user()->roles->first()->name, array('Administrator', 'CEO')), function ($q) {
